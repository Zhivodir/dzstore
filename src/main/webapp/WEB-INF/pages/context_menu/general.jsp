...
<ul id="contextMenu" class="dropdown-menu" role="menu" style="display:none" >
    ...
    <li class="divider"></li>
    <li class="contextHref li_starred"><input type="button" class="contextInput" onclick="addStar()" value="Add star"></li>
    <li class="contextHref li_removestar"><input type="button" class="contextInput" onclick="removeStar()" value="Remove star"></li>
    <li class="divider"></li>
