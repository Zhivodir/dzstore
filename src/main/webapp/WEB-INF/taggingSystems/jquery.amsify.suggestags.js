    ...
    AmsifySuggestags.prototype = {
      ...
      setEvents: function () {
        ...
        $(this.selectors.sTagsInput).keyup(function (e) {
          ...
          if (keycode == '13' || keycode == '32' || keycode == '9') {
            ...
            var success = _self.addTag(value);
            if (success) {
              $(this).val('');
            }
        ...
        $(this.selectors.listArea).find(this.classes.listItem).click(function () {
          var success = _self.addTag($(this).data('val'));
          if (success) {
      ...
      addTag: function (value) {
        ...
        if (this.isValidate(value)) {
          ...
          $(this.selectors.listArea).hide();
          if (settings.validationCorrect && typeof settings.validationCorrect == "function") {
            settings.validationCorrect();
          }
        } else {
          if (settings.validationError && typeof settings.validationError == "function") {
            settings.validationError(value);
            return false;
          }
        }
        return true;
      ...
      isValidate: function (value) {
        ...
        if (settings.pattern != false) {
          var currentValidateEmail = value.trim();
          if (currentValidateEmail.length != 0 && !settings.pattern.test(currentValidateEmail)) {
            isValid = false;
          }
        }
        return isValid;
